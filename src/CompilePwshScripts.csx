...
public class CompilePwshScripts : Task
{
    ...
    private void PreloadPowerShellAssemblies()
    {
        ...
        var basePath = Path.Combine(userProfile, ".nuget", "packages", "system.management.automation", "7.4.1", "runtimes");

        var candidates = new[]
        {
            Path.Combine(basePath, "win", "lib", "net8.0", "System.Management.Automation.dll"),
            Path.Combine(basePath, "linux", "lib", "net8.0", "System.Management.Automation.dll"),
            Path.Combine(basePath, "osx", "lib", "net8.0", "System.Management.Automation.dll")
        };
